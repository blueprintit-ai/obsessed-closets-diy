        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="max-w-4xl mx-auto animate-fadeIn">
            <h1 className="text-4xl lg:text-6xl font-bold mb-4">
              Your Dream Closet is Now DIY-able. And up to 70% Off.
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                High-quality materials and precision fabrication with the option for delivery to your door.
              </p>
            </div>
      ...
      <section id="process" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From initial consultation to final installation, we guide you through every step of creating your organized space.
            </p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-8">
              <div className="lg:w-1/2">
                ...
                <div className="flex items-center text-blue-600">
                  ...
                  <span className="font-medium">Optional delivery to your driveway or garage</span>
                </div>
              </div>
              <div className="lg:w-1/2">
                <div className="bg-slate-100 rounded-lg p-8 h-64 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                As a local family owned small business, we treat every customer like family and stand behind our work with our personal commitment.
              </p>
            </div>
