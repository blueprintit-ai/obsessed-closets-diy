        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex space-x-8">
              <button onClick={() => scrollToSection('process')} className="text-gray-700 hover:text-blue-600 font-medium">Process</button>
              <button onClick={() => scrollToSection('training')} className="text-gray-700 hover:text-blue-600 font-medium">Training</button>
              <button onClick={() => scrollToSection('quality')} className="text-gray-700 hover:text-blue-600 font-medium">Quality</button>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t">
              <div className="flex flex-col space-y-4">
                <button onClick={() => scrollToSection('process')} className="text-gray-700 hover:text-blue-600 font-medium text-left">Process</button>
                <button onClick={() => scrollToSection('training')} className="text-gray-700 hover:text-blue-600 font-medium text-left">Training</button>
                <button onClick={() => scrollToSection('quality')} className="text-gray-700 hover:text-blue-600 font-medium text-left">Quality</button>
                <button onClick={() => scrollToSection('about')} className="text-gray-700 hover:text-blue-600 font-medium text-left">About</button>
                <button onClick={() => scrollToSection('contact')} className="text-gray-700 hover:text-blue-600 font-medium text-left">Contact</button>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                variant="outline" 
                className="text-black border-white hover:bg-white hover:text-black text-lg px-8 py-3 bg-white"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <div className="lg:w-1/2">
                <div className="flex items-center mb-4">
                  <Badge className="bg-blue-600 text-white text-lg px-4 py-2 mr-4">Step 1</Badge>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-8">
              <div className="lg:w-1/2">
                <div className="flex items-center mb-4">
                  <Badge className="bg-blue-600 text-white text-lg px-4 py-2 mr-4">Step 2</Badge>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <div className="lg:w-1/2">
                <div className="flex items-center mb-4">
                  <Badge className="bg-blue-600 text-white text-lg px-4 py-2 mr-4">Step 3</Badge>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-8">
              <div className="lg:w-1/2">
                <div className="flex items-center mb-4">
                  <Badge className="bg-blue-600 text-white text-lg px-4 py-2 mr-4">Step 4</Badge>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <div className="lg:w-1/2">
                <div className="flex items-center mb-4">
                  <Badge className="bg-blue-600 text-white text-lg px-4 py-2 mr-4">Step 5</Badge>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button onClick={() => scrollToSection('process')} className="block text-gray-400 hover:text-blue-400">Our Process</button>
                <button onClick={() => scrollToSection('training')} className="block text-gray-400 hover:text-blue-400">Training & Support</button>
                <button onClick={() => scrollToSection('quality')} className="block text-gray-400 hover:text-blue-400">Quality Assurance</button>
                <button onClick={() => scrollToSection('about')} className="block text-gray-400 hover:text-blue-400">About Us</button>
              </div>
            </div>
